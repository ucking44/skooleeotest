      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview {{ Request::is('company*') ? 'menu-open' : '' }}">
            {{-- <a href="#" class="nav-link {{ Request::is('prospective/vendor*') ? 'active' : '' }}"> --}}
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="{{ route('admin.company.create') }}" class="nav-link active">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Create company</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('admin.company.index') }}" class="nav-link active {{ Request::is('company*') ? 'active' : '' }}">
                    <i class="far fa-circle nav-icon"></i>
                    <p>All companies</p>
                    </a>
                </li>
          ...
          {{-- <li class="nav-item">
            ...
            <li class="nav-item has-treeview {{ Request::is('employee*') ? 'menu-open' : '' }}">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ route('admin.employee.create') }}" class="nav-link {{ Request::is('employee/create*') ? 'active' : '' }}">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Create Employee</p>
                        </a>
                    </li>
                <li class="nav-item">
                    <a href="{{ route('admin.employee.index') }}" class="nav-link {{ Request::is('employee/index*') ? 'active' : '' }}">
                    <i class="far fa-circle nav-icon"></i>
                    <p>All Employees</p>
                    </a>
                </li>
